 ...
 --%>			</div>
		...
		<div id="InputBox">
			<div id="textframe">
				...
				<label style="margin-top:5px; margin-left:15px;float:left; background-color:rgba(255,255,255,0);">
				    <input type="checkbox" class="hidden-input" value="1" checked="checked" onclick="highlight(this);"/>
				    <span class="your style about checkbox">高亮</span>
				</label>
				<input type="submit" value="检索" class="SearchButton"   
	...
	<div class="small_main">
	    ...
	    <div id="small_main_result" class="small_main_result">
			<%@ include file="aggregate_sen.jsp"%>
<%-- 			<%@ include file="aggregate_sen.160229bak.jsp"%> --%>
