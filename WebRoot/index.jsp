...
<body>
    ...
    <div class = "div-bubble">
		...
		<div class = "div-logo" onclick="javascrtpt:window.location.href='/small/chapter'">
 		...
 		<div class = "selectZone">
				...
				<div class="select">
<!-- 						<a class="button button--style01"  onClick="javascrtpt:window.location.href='/asir'">普通检索</a> -->
						<a class="button button--style01"  onClick="javascript:window.location.href='/small/chapter'">细粒度检索</a>
				</div>
